...
import { Briefcase, Mail, Lock, AlertCircle, ArrowRight, Eye, EyeOff } from 'lucide-react';
        ...
        <div className="relative z-10 my-auto flex flex-col items-center justify-center">
          ...
          <div className="mt-8 text-center max-w-md">
            ...
            <p className="mt-2 text-sm text-gray-500 leading-relaxed">
              Your two-way marketplace for tech & non-tech opportunities. Pick up right where you left off.
            </p>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-left">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Sign in to your WorkBridge account to collaborate.
            </p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-gray-400">
              By signing in, you agree to WorkBridge's{' '}
